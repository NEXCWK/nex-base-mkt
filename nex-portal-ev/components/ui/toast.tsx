...
>(({ className, variant = 'default', ...props }, ref) => (
  <ToastPrimitive.Root
    ...
    className={cn(
      ...
      variant === 'success' && 'border-nex-yellow bg-nex-yellow-light text-nex-black',
      variant === 'default' && 'border-gray-200 bg-white text-black',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Action
    ref={ref}
    className={cn('inline-flex h-8 shrink-0 items-center justify-center rounded border px-3 text-sm font-medium', className)}
    {...props}
  />
))
